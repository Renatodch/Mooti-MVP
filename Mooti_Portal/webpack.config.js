...
module.exports = {
    ...
    entry: [
        './src/index.js' //Punto de entrada con su dirección.Aquí vive el código inicial y de aquí parte al desarrollo.
    ],
    ...
    resolve: {
        extensions: ['.js','.jsx','.ts','.tsx'], //Extensiones que vamos a utilizar.
    },
    module: { //Se crea un modulo con las reglas necesarias que vamos a utilizar.
        rules: [    //Reglas
            {   // Estructura de Babel
                test: /\.(js|jsx)?$/, //Nos permite identificar los archivos según se encuentran en nuestro entorno.
